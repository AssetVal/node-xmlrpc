...
class Client {
        ...
        if (typeof options === 'string') {
            ...
            Object.keys(defaultHeaders).forEach((key) => {
                if (!this._options.headers?.[key])
                    this._options.headers[key] = defaultHeaders[key];
            });
            if (cookies) {
    ...
    methodCall(method, params, callback) {
        ...
        const xml = (0, serializer_1.serializeMethodCall)(method, params, options.encoding);
        const transport = this._isSecure ? https_1.default : http_1.default;
        ...
        const request = transport.request(options, (response) => {
            ...
            if (response.statusCode === 404) {
                ...
                const deserializer = new deserializer_1.default(options.responseEncoding);
