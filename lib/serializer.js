...
const xmlBuilder = require('xmlbuilder'), dateFormatter = require('./date_formatter'), CustomType = require('./customtype');
/**
...
function serializeValue(value, xml) {
    let stack = [{ value: value, xml: xml }], current = null, valueNode = null, next = null;
