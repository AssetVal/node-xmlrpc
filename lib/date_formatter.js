...
class DateFormatter {
    ...
    ISO8601 = new RegExp('([0-9]{4})([-]?([0-9]{2}))([-]?([0-9]{2}))' +
    ...
    decodeIso8601(time) {
        ...
        if (!dateParts)
            throw new Error(`Expected a ISO8601 date time but got '${time}'`);
        let date = [
...
exports.default = new DateFormatter();
