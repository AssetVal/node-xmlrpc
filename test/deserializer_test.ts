  ...
  .addBatch({
    'deserializeMethodResponse() called with': {
      ...
      type: {
        boolean: {
          'set to a true value': {
            topic: deserializeMethodResponseFixture(
              'good_food/boolean_true_response.xml'
            ),
          ...
          'set to a false value': {
            topic: deserializeMethodResponseFixture(
              'good_food/boolean_false_response.xml'
            ),
            'does not return an error': assertOk,
          ...
          'containing an illegal value': {
            topic: deserializeMethodResponseFixture(
              'bad_food/illegal_boolean_response.xml'
            ),
            'results in an error': assertError
          }
        },
        ...
        datetime: {
          'set to valid ISO8601 date': {
            topic: deserializeMethodResponseFixture(
              'good_food/datetime_response.xml'
            ),
            'does not return an error': assertOk,
            'results in a matching Date object': assertResponse(
              new Date(2012, 5, 8, 11, 35, 10)
            )
          },
          'containing an illegal value': {
            topic: deserializeMethodResponseFixture(
              'bad_food/illegal_datetime_response.xml'
            ),
            'results in an error': assertError
          }
        },
        ...
        base64: {
          topic: deserializeMethodResponseFixture(
            'good_food/base64_response.xml'
          ),
          'does not return an error': assertOk,
          'results in the correct buffer': assertResponse(
            new Buffer('dGVzdGluZw==', 'base64')
          )
        },
        ...
        double: {
          'set to ~\u03c0': {
            topic: deserializeMethodResponseFixture(
              'good_food/double_positive_response.xml'
            ),
            'does not return an error': assertOk,
          ...
          'set to -\u221a2': {
            topic: deserializeMethodResponseFixture(
              'good_food/double_negative_response.xml'
            ),
            'does not return an error': assertOk,
          ...
          'set to an illegal value': {
            topic: deserializeMethodResponseFixture(
              'bad_food/illegal_double_response.xml'
            ),
            'results in an error': assertError
          }
        },
        ...
        int: {
          'set to a positive value': {
            topic: deserializeMethodResponseFixture(
              'good_food/int_positive_response.xml'
            ),
            'does not return an error': assertOk,
          ...
          'set to a negative value': {
            topic: deserializeMethodResponseFixture(
              'good_food/int_negative_response.xml'
            ),
            'does not return an error': assertOk,
            'results in the correct number': assertResponse(-4)
          },
          'set to zero': {
            topic: deserializeMethodResponseFixture(
              'good_food/int_zero_response.xml'
            ),
            'does not return an error': assertOk,
          ...
          'set to an illegal value': {
            topic: deserializeMethodResponseFixture(
              'bad_food/illegal_int_response.xml'
            ),
            'results in an error': assertError
          }
        },
        ...
        i4: {
          'set to a positive value': {
            topic: deserializeMethodResponseFixture(
              'good_food/i4_positive_response.xml'
            ),
            'does not return an error': assertOk,
            'results in the correct number': assertResponse(4)
          },
          'set to a negative value': {
            topic: deserializeMethodResponseFixture(
              'good_food/i4_negative_response.xml'
            ),
            'does not return an error': assertOk,
            'results in the correct number': assertResponse(-4)
          },
          'set to zero': {
            topic: deserializeMethodResponseFixture(
              'good_food/i4_zero_response.xml'
            ),
            'does not return an error': assertOk,
            'results in the correct number': assertResponse(0)
          },
          'set to an illegal value': {
            topic: deserializeMethodResponseFixture(
              'bad_food/illegal_i4_response.xml'
            ),
            'results in an error': assertError
          }
        },
        ...
        i8: {
          'set to a positive value': {
            topic: deserializeMethodResponseFixture(
              'good_food/i8_positive_response.xml'
            ),
            'does not return an error': assertOk,
            'results in the correct string': assertResponse(
              '4611686018427387904'
            )
          },
          'set to a negative value': {
            topic: deserializeMethodResponseFixture(
              'good_food/i8_negative_response.xml'
            ),
            'does not return an error': assertOk,
            'results in the correct string': assertResponse(
              '-4611686018427387904'
          ...
          'set to zero': {
            topic: deserializeMethodResponseFixture(
              'good_food/i8_zero_response.xml'
            ),
            'does not return an error': assertOk,
          ...
          'set to an illegal value': {
            topic: deserializeMethodResponseFixture(
              'bad_food/illegal_i8_response.xml'
            ),
            'results in an error': assertError
          }
        },
        ...
        string: {
          ...
          'without content': {
            topic: deserializeMethodResponseFixture(
              'good_food/string_empty_response.xml'
            ),
            'does not return an error': assertOk,
          ...
          'containing CDATA': {
            topic: deserializeMethodResponseFixture(
              'good_food/string_cdata_response.xml'
            ),
            'does not return an error': assertOk,
      ...
      'a param of unspecified type': {
        topic: deserializeMethodResponseFixture(
          'good_food/unspecified_type_response.xml'
        ),
        'does not return an error': assertOk,
      ...
      compound: {
        array: {
          ...
          'containing no values': {
            topic: deserializeMethodResponseFixture(
              'good_food/array_empty_response.xml'
            ),
            'does not return an error': assertOk,
          ...
          'that has one nested ARRAY': {
            topic: deserializeMethodResponseFixture(
              'good_food/array_nested_response.xml'
            ),
            'does not return an error': assertOk,
            'results in an array containing another array': assertResponse([
              178,
              'testLevel1String',
              ['testString', 64]
            ])
          ...
          'that has a nested ARRAY followed by more simple values': {
            topic: deserializeMethodResponseFixture(
              'good_food/array_nested_with_trailing_values_response.xml'
            ),
            'does not return an error': assertOk,
        ...
        struct: {
          'containing simple values': {
            topic: deserializeMethodResponseFixture(
              'good_food/struct_response.xml'
            ),
            'does not return an error': assertOk,
            'results in a matching object': assertResponse({
              'the-Name': 'testValue'
            })
          },
          'containing an implicit string': {
            topic: deserializeMethodResponseFixture(
              'good_food/struct_implicit_string_response.xml'
            ),
            'does not return an error': assertOk,
            'results in a matching object': assertResponse({
              'the-Name': 'testValue'
          ...
          'that has whitespace after the name element': {
            topic: deserializeMethodResponseFixture(
              'good_food/struct_with_whitespace_response.xml'
            ),
            'does not return an error': assertOk,
            'results in a matching object': assertResponse({
              'the-Name': 'testValue'
          ...
          'containing another struct': {
            topic: deserializeMethodResponseFixture(
              'good_food/struct_nested_response.xml'
            ),
            'does not return an error': assertOk,
            'results in a matching object': assertResponse({
              theName: 'testValue',
        ...
        fault: {
          'which includes error information': {
            ...
            'results in an error': assertError,
            'which has all properties of a proper xmlrpc fault': function (
              error,
              r
            ) {
              assert.strictEqual(
                error.message,
                'XML-RPC fault: Too many parameters.'
              );
          ...
          'which does not include error information': {
            topic: deserializeMethodResponseFixture(
              'good_food/fault_empty.xml'
            ),
            'results in an error': assertError
          },
          'that contains an empty string': {
            topic: deserializeMethodResponseFixture(
              'good_food/fault_explicit_empty.xml'
            ),
            'results in an error': assertError
          }
        },
        ...
        'a very large response': {
          topic: deserializeMethodResponseFixture(
            'good_food/very_large_response.xml'
          ),
          'does not return an error': assertOk,
          'results in a matching object': function (error, result) {
            var resultsFile = path.join(
              __dirname,
              'fixtures',
              'good_food',
              'very_large_response_results.json'
            );
