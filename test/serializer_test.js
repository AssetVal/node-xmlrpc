...
var vows = require('vows'), path = require('path'), fs = require('fs'), assert = require('assert'), Serializer = require('../lib/serializer'), CustomType = require('../lib/customtype'), util = require('util');
vows
    .describe('Serializer')
    .addBatch({
