...
vows
    ...
    'A local date': {
        ...
        'when encoded': {
            ...
            'without offset': encodeCase({ offset: false }, 'T\\d{2}[:]?\\d{2}[:]?' + '\\d{2}(\\.\\d{3})?$'),
            'with offset': encodeCase({ offset: true }, '([+-]\\d{2}[:]\\d{2}|Z)$'),
            'with milliseconds': encodeCase({ ms: true }, '\\.\\d{3}([+-]\\d{2}[:]' + '\\d{2}|Z)?$'),
    ...
    .addBatch({
    'When decoding': {
        'YYYY-MM-DDTHH:mm:ss.mss': decodeCase('2014-01-20T14:25:25.050', localDate(2014, 0, 20, 14, 25, 25, 50)),
        'YYYY-MM-DDTHH:mm:ss': decodeCase('2014-01-20T14:25:25', localDate(2014, 0, 20, 14, 25, 25)),
        'YYYY-MM-DDTHH:mm': decodeCase('2014-01-20T14:25', localDate(2014, 0, 20, 14, 25)),
        'YYYY-MM-DDTHH': decodeCase('2014-01-20T14', localDate(2014, 0, 20, 14)),
        'YYYY-MM-DD': decodeCase('2014-01-20', localDate(2014, 0, 20)),
        'YYYYMMDDTHH:mm:ss': decodeCase('20140120T14:25:25', localDate(2014, 0, 20, 14, 25, 25)),
        YYYYMMDDTHHmmss: decodeCase('20140120T142525', localDate(2014, 0, 20, 14, 25, 25)),
        YYYYMMDDTHHmm: decodeCase('20140120T1425', localDate(2014, 0, 20, 14, 25)),
        YYYYMMDD: decodeCase('20140120', localDate(2014, 0, 20)),
        'YYYY-MM-DDTHH:mm:ss.mssZ': decodeCase('2014-01-20T14:25:25.050Z', '2014-01-20T14:25:25.050Z'),
        'YYYY-MM-DDTHH:mm:ssZ': decodeCase('2014-01-20T14:25:25Z', '2014-01-20T14:25:25.000Z'),
        'YYYY-MM-DDTHHZ': decodeCase('2014-01-20T14Z', '2014-01-20T14:00:00.000Z'),
        'YYYY-MM-DDTHH:mm:ss.mss+hh:mm': decodeCase('2014-01-20T14:25:25.000+09:30', function () {
            var d = new Date('2014-01-20T14:25:25.000Z');
            d.setUTCHours(d.getUTCHours() - 9);
            d.setUTCMinutes(d.getUTCMinutes() - 30);
            return d.toISOString();
        }),
        'YYYY-MM-DDTHH:mm:ss.mss+hhmm': decodeCase('2014-01-20T14:25:25.000+0930', function () {
            var d = new Date('2014-01-20T14:25:25.000Z');
            d.setUTCHours(d.getUTCHours() - 9);
            d.setUTCMinutes(d.getUTCMinutes() - 30);
            return d.toISOString();
        }),
        'YYYY-MM-DDTHH:mm:ss.mss+hh': decodeCase('2014-01-20T14:25:25.000+09', function () {
            var d = new Date('2014-01-20T14:25:25.000Z');
            d.setUTCHours(d.getUTCHours() - 9);
            return d.toISOString();
        })
